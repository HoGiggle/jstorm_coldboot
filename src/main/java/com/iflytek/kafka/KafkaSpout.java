...
import static com.iflytek.preprocess.TupleField.REQUEST_ID;
...
public class KafkaSpout implements IRichSpout {
	...
	public static final String SPOUT_FIELD = "bytes";
...
//        }
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(TupleMsgId.addIdField(new Fields(SPOUT_FIELD),REQUEST_ID));
//		declarer.declare(new Fields(SPOUT_FIELD,REQUEST_ID));
